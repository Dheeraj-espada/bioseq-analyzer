#!/usr/bin/env python3
"""
HTML Report Generator for Sequence Analysis
...
class HTMLReportGenerator:
    ...
    def add_visualizations(self, title, image_paths):
        ...
        for img_path in image_paths:
            ...
            if img_data:
                html += f'<div class="visualization"><img src="{img_data}" alt="visualization"></div>'
        html += '</div>'
        self.sections.append(html)
...
"""
    ...
    <div class="footer">
        <p>Generated by BioSeq Analyzer | """ + self.timestamp + """</p>
    </div>
</div>
</body>
</html>
...
if __name__ == "__main__":
    ...
    report = HTMLReportGenerator("Sample Analysis")
    report.add_summary({
        "Total Sequences": "8",
        "Total Base Pairs": "45,678",
        "Average GC%": "52.34%",
        "ORFs Found": "156"
    })
    report.add_findings([
        "Average GC content indicates high gene density",
        "156 ORFs identified with average length 324 bp",
        "No contamination detected"
    ])
    report.generate("sample_report.html")
